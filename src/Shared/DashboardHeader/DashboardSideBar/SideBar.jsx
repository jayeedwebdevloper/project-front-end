                                    ...
                                    <>
                                        ...
                                        <Disclosure.Panel className="hover:bg-transparent panelbg focus:bg-white p-0 w-full">
                                            <div className='flex flex-col w-full ps-5'>
                                                <Link to={'/dashboard876admingo/slider'} className='text-white text-[17px] flex gap-3 items-center p-3 rounded-md hover:bg-black/10 w-full'><svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" className='fill-white' viewBox="0 0 512 512"><path d="M448 80c8.8 0 16 7.2 16 16V415.8l-5-6.5-136-176c-4.5-5.9-11.6-9.3-19-9.3s-14.4 3.4-19 9.3L202 340.7l-30.5-42.7C167 291.7 159.8 288 152 288s-15 3.7-19.5 10.1l-80 112L48 416.3l0-.3V96c0-8.8 7.2-16 16-16H448zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm80 192a48 48 0 1 0 0-96 48 48 0 1 0 0 96z" /></svg> Slider</Link>
                                                <Link to={'/dashboard876admingo/interview'} className='text-white text-[17px] flex gap-3 items-center p-3 rounded-md hover:bg-black/10 w-full'><svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" className='fill-white' viewBox="0 0 512 512"><path d="M75 75L41 41C25.9 25.9 0 36.6 0 57.9V168c0 13.3 10.7 24 24 24H134.1c21.4 0 32.1-25.9 17-41l-30.8-30.8C155 85.5 203 64 256 64c106 0 192 86 192 192s-86 192-192 192c-40.8 0-78.6-12.7-109.7-34.4c-14.5-10.1-34.4-6.6-44.6 7.9s-6.6 34.4 7.9 44.6C151.2 495 201.7 512 256 512c141.4 0 256-114.6 256-256S397.4 0 256 0C185.3 0 121.3 28.7 75 75zm181 53c-13.3 0-24 10.7-24 24V256c0 6.4 2.5 12.5 7 17l72 72c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-65-65V152c0-13.3-10.7-24-24-24z" /></svg> Interview</Link>
                                            </div>
                                        </Disclosure.Panel>
                                    </>
                                )}
