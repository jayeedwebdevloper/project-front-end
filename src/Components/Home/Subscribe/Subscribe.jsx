...
const Subscribe = () => {
    const almuniSocial = [
        {
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" viewBox="0 0 16 16">
    ...
    return (
        <div className='w-full subscribe-bg'>
            ...
            <div className="container mx-auto px-4 lg:px-5">
                <div className="flex items-center flex-col justify-center py-24">
                    ...
                    <form className='w-full flex items-center justify-center flex-col'>
                        <input type="email" placeholder='Your E-mail Address' className="bg-transparent border-b-2 w-full md:w-1/3 mx-auto text-center mt-5 py-2 text-white border-slate-500 focus:border-slate-200 focus:border-b-2 focus:outline-none" name='email' />
                        <button className='btn btn-warning uppercase rounded-none mt-8 font-thin tracking-widest text-slate-100'>Subscribe</button>
                    </form>
                </div>
            </div>
        </div>
