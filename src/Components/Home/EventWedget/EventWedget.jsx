    ...
    return (
        <div className='py-10 bg-slate-100'>
            <div className="container mx-auto px-2 lg:px-3 xl:px-14">
                <h2 className='text-3xl uppercase text-center pb-8 tracking-wider'>Upcoming Event</h2>
                {
                        ...
                        <div key={i} className="lg:flex">
                            ...
                            <div className="w-full lg:w-1/2">
                                <div className='flex pt-8 lg:pt-0'>
                                    <div className='ps-5'>
                                        <h1 className='font-semibold text-2xl xl:text-4xl tracking-wide text-gray-700 leading-snug'>{data.title}</h1>
                                ...
                                <div className="counter ps-5 lg:flex items-center gap-5 lg:mt-16 mt-5">
                                    <div className="py-3">
